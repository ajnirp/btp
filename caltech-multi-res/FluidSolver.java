...
public class FluidSolver
{
     ...
     * velocity field, i.e., a divergence-free field.
     *
    ...
    // linearSolver(0, u, uOld, 1 + 4 * dt * diff * n * n);
    // linearSolver(0, v, vOld, 1 + 4 * dt * diff * n * n);
    /*
     * @param b Flag to specify how boundries should be handled.
     * @param x The array to store the results of the diffusion
     * computation.
     * @param x0 The input array on which we should compute
     * diffusion.
     */
